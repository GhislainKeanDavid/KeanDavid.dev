<script lang="ts">
	...
	const projects = [
		{
			...
			tags: ['Svelte', 'n8n', 'Supabase', 'Retell AI', 'Anthropic API', 'Google Sheets', 'Claude', 'Antigravity'],
		...
		},
		{
			...
			tags: ['n8n', 'Docker', 'GPT-4o', 'Gmail API', 'Google Sheets', 'Telegram API', 'Claude', 'Antigravity'],
	...
	const techIcons: Record<string, string> = {
		...
		'Antigravity': `<path d="M12 2L2 12l10 10 10-10L12 2zm0 3.3L18.7 12 12 18.7 5.3 12 12 5.3z M12 8a4 4 0 110 8 4 4 0 010-8z" fill="currentColor"/>`,
					...
					<div class="project-info-side">
						...
						<div class="project-tech-only">
							{#each project.tags as tag}
								<div class="tech-logo-badge">
									<svg viewBox="0 0 24 24" class="tech-logo-icon">
										{@html techIcons[tag] || fallbackIcon}
									</svg>
...
<style>
	...
	.tech-logo-badge:hover {
		...
		transform: translateY(-2px);
		box-shadow: 0 4px 10px rgba(217, 90, 56, 0.15);
	}
